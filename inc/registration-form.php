                            ...
                            <div class="section-field mb-3">
                                ...
                                <div class="field-widget"> <i class="glyph-icon flaticon-padlock"></i>
                                    <input type="password" value="" placeholder="password" name="password1"
                                        id="password1" pattern="^(?=.*[A-Za-z])(?=.*\d)(?=.*[@$!%*#?&])[A-Za-z\d@$!%*#?&]{8,}$" />
                                </div>
                                <p style="text-align: left;font-size=5px; color: yellow;">Minimum eight characters, at least one letter, one number and one special character</p>
                            </div>
                            
                            <div class="section-field mb-3">
                                <div class="field-widget"> <i class="glyph-icon flaticon-padlock"></i>
                                    <input type="password" value="" placeholder="confirm password" name="password2"
                                        id="password2" pattern="^(?=.*[A-Za-z])(?=.*\d)(?=.*[@$!%*#?&])[A-Za-z\d@$!%*#?&]{8,}$" />
                                    <div class="alignleft">
