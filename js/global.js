var socket = io('https://quigleybrook.com:3000');
      ...
      let html = '<div class="qs-notif--item">\
                    ...
                    <div class="qs-notif--content">\
                        <div class="qs-notif--part">\
                            <a href="https://quigleybrook.com/profile/?id=' + uid + '" target="_blank">' + data[1] + '</a> sent you \
                            <svg role="img">\
                                <use href="' + ajax_object.directory_uri + '/icons/icons.svg#' + flirts + '"/>\
                            </svg>\
                            <div class="qs-notif--btn">\
                                <a class="qs-btn btn-secondary btn-xsm" href="https://quigleybrook.com/profile/?id=' + uid + '" target="_blank">See profile</a>\
                            </div>\
                        </div>\
                        <div class="qs-notif--part">\
