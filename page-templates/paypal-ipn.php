        ...
        if($prevPayment->num_rows > 0){ 
            ...
            if($txn_type == 'subscr_payment' || $txn_type == 'subscr_signup'){ 
                ...
                if($insert && !empty($custom)){ 
                    ...
                    $update = $db->query("UPDATE wp_users SET subscription_id = {$subscription_id} WHERE id = {$custom}"); 
                    wp_update_user( array( 'ID' => $custom, 'role' => 'membership' ));
                } 
            } 
        } 
    } 
