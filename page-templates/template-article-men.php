    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12" style="display:none;">
              <?php if($user_id!=0){ ?><a class="qs-btn btn-primary btn-sm" href="<?php echo get_site_url(); ?>/demo-articles/"><?php }else{ ?><a class="qs-btn btn-primary btn-sm" href="<?php echo get_site_url(); ?>/choose-gender/"><?php } ?>
            ...
            <div class="col-lg-11 col-md-12 mauto" style="display:none;">
                ...
                <div class="col-lg-12 top_hd_srch_mmbr">
                    <h1 class="color-black text-center">Articles for Men</h1>
                </div>
            </div>
